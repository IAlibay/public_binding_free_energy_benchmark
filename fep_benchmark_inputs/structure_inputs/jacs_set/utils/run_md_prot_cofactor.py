...
cofactor = [openfe.SmallMoleculeComponent(m) for m in Chem.SDMolSupplier('cofactor.sdf', removeHs=False)][0]
...
system = openfe.ChemicalSystem({'p': prot, 's': solv, 'c': cofactor})
